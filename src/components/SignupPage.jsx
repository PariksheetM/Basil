        ...
        >
            ...
            <div className="relative w-full max-w-[420px] bg-white rounded-3xl shadow-2xl p-6 md:p-10 animate-fade-in-up">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-xl font-bold text-gray-900 mb-2 font-display">Create Account</h2>
                    <p className="text-xs text-gray-500 text-sm">Join us for seamless bulk food ordering</p>
                </div>
